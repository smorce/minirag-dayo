...
"""
    ...
    if query_param.include_provenance:
        # entities: from node_datas (entity_name, Score, description)
        entities_used = [
            {
        ...
        # chunks: pair final_chunk_id with fetched chunk data
        chunks_used = []
        ...
        return {"context": context_str, "provenance": {"entities": entities_used, "chunks": chunks_used}}
...
async def minirag_query(  # MiniRAG
    ...
    if query_param.only_need_context:
        return context if query_param.include_provenance else context_str
