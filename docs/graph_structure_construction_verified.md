...
- 返却仕様:
  - `include_provenance=False`（既定）: 文字列の回答のみ
  - `include_provenance=True`:
    - `{ "answer": <str>, "provenance": { "entities": [...], "chunks": [...] } }`
    - また `only_need_context=True` の場合は `{ "context": <str>, "provenance": {...} }`
